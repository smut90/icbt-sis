                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $sql = "SELECT * FROM modules LEFT JOIN `courses` ON modules.course_id = courses.courses_id LIMIT $offset, $rowsperpage";
                                            $result = mysqli_query($conn, $sql);
                                            while ($list = mysqli_fetch_assoc($result)) {
                                        ?>

                                            <tr>
                                                <th scope="row"><?= $list['modeule_name']?></th>
                                                <th scope="row"><?= $list['module_code']?></th>
                                                <td><?= nl2br($list['module_description']) ?></td>
                                                <td><?= $list['course_name']?></td>
                                                <td>
                                                    <a title="View Information" href="view?view&id=<?= $list['module_id'] ?>" class="btn btn-info btn-sm ">View <span class="fa fa-info-circle fw-fa"></span></a>
                                                </td>
                                            </tr>
