                            ...
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $sql = "SELECT * FROM courses LEFT JOIN `departments` ON courses.course_department = departments.department_id LIMIT $offset, $rowsperpage";
                                            $result = mysqli_query($conn, $sql);
                                            while ($list = mysqli_fetch_assoc($result)) {
                                        ?>

                                            <tr>
                                                <th scope="row"><?= $list['course_name']?></th>
                                                <td><?= nl2br($list['course_description']) ?></td>
                                                <td><?= $list['department_name']?></td>
                                                <td>
                                                    <a title="View Information" href="view?view&id=<?= $list['courses_id'] ?>" class="btn btn-info btn-sm ">View <span class="fa fa-info-circle fw-fa"></span></a>
                                                </td>
                                            </tr>
