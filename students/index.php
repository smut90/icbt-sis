                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <th scope="row"><?= $list['enrolement_id']?></th>
                                                <td><?= $list['student_first_name'].' '.$list['student_last_name']?></td>
                                                <td><?= $list['student_sex']?></td>
                                                <td><?= $list['student_age']?></td>
                                                <td><?= $list['student_email']?></td>
                                                <td><?= $list['student_contact_number']?></td>
                                                <td>
                                                    <a title="View Information" href="view?view&id=<?= $list['student_id'] ?>" class="btn btn-info btn-sm ">View <span class="fa fa-info-circle fw-fa"></span></a>
                                                    <a title="View Grades" href="<?= BASE_URL.'student-grades/view?view&id='.$list['student_id'] ?>" class="btn btn-primary btn-sm">Grades <span class="fa fa-info-circle fw-fa"></span> </a>
                                                </td>
                                            </tr>
